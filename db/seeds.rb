...
User.create(name: "admin", email: "admin@example.com", password: "qweqweqwe", password_confirmation: "qweqweqwe", admin: true)

5.times do |count|
  @user = User.create(name: "user#{count}", email: "user#{count}@example.com", password: "qweqweqwe", password_confirmation: "qweqweqwe", avatar: File.open(sample_user_images[count]), admin: false)
  5.times do |post|
